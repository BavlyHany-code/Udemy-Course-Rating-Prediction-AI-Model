...
def load_data():
    ...
    dataset_path = os.path.join(BASE_DIR, '../data set/dataset.csv')
  ...
  # 3. Drop unnecessary columns
    columns_to_drop = [
       'avg_rating', 'url', 'created', 
        'discount_price__currency', 'published_time',
...
def main():
    ...
    if st.button('Predict Rating'):
            ...
            rf = joblib.load(r'D:\Materials\GDG\work space\rf model')
